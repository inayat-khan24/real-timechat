        ...
        <div className="w-full lg:w-1/3 border-r overflow-y-auto p-4">
          ...
          {allUsers
            ...
            .map((user, idx) => (
              ...
              > 
                <img
  src={user.profilePic ? `http://localhost:5000/uploads/${user.profilePic}` : 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3'}
